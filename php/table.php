...
$SQL ="SELECT COUNT(*) AS count FROM doc.Tack ".$WhereSql ;
//echo $SQL.'<br>';
...
while($row = mysqli_fetch_array($result,MYSQL_ASSOC)) {
	...
	"</td>".
	"<td>".
	"<input type='BUTTON' value='↑' OnClick='up(".$row['id'].")'>".
	"</td>"."</tr>".
	"<tr>"."<td>".
	"<input type='BUTTON' value='↓' OnClick='down(".$row['id'].")'>".
	"</td>"."</tr>"."</table>"."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Disable']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Name']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Replay']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Type']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Begin']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['End']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Delay']."]]></cell>";
	$s .= "<cell><![CDATA[". $row['Content']."]]></cell>";
    $s .= "</row>";
}
$s .= "</rows>";
